// -*- C++ -*-
//
// Package:    DiElectronMcFilter
// Class:      DiElectronMcFilter
// 
/**\class DiElectronMcFilter DiElectronMcFilter.cc MyFilters/DiElectronMcFilter/src/DiElectronMcFilter.cc
...
class DiElectronMcFilter : public edm::EDFilter {
   public:
      explicit DiElectronMcFilter(const edm::ParameterSet&);
      ~DiElectronMcFilter();
...
//
DiElectronMcFilter::DiElectronMcFilter(const edm::ParameterSet& iConfig)
{
...
DiElectronMcFilter::~DiElectronMcFilter()
{
...
bool
DiElectronMcFilter::filter(edm::Event& iEvent, const edm::EventSetup& iSetup)
{
	...
	reco::GenParticle WminusDecay2; WminusDecay2 = (*ttbarEvent)[9][0];
        ...
        bool res = (isElectronic(WplusDecay1) && isElectronic(WminusDecay1) );
	return (invert_) ? ! res : res; 
}

// ------------ method called once each job just before starting event loop  ------------
void 
DiElectronMcFilter::beginJob()
{
}

// ------------ method called once each job just after ending the event loop  ------------
void 
DiElectronMcFilter::endJob() {
}

//define this as a plug-in
DEFINE_FWK_MODULE(DiElectronMcFilter);
