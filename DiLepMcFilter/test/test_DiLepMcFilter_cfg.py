...
process = cms.Process('TestDiLepMcFilter')
...
process.load("MyFilters.DiLepMcFilter.diLepMcFilter_cfi")
process.printList = cms.EDAnalyzer("ParticleListDrawer",
        src = cms.InputTag("genParticles"),
        maxEventsToPrint = cms.untracked.int32(10)
)
process.TFileService=cms.Service("TFileService",fileName=cms.string('test_DiLepMcFilter_histos.root'))

process.generation_step = cms.Path(process.myTTbarGenEvent10Parts*process.DiLepMcFilter * process.genHists)# * process.printList)

process.output = cms.OutputModule("PoolOutputModule",
                                  fileName = cms.untracked.string('test_DiLepMcFilter_selected.root'),
